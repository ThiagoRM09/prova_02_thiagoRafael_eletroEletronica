function quiloWatts() {
    let qtdQWatts = parseFloat(prompt("Digite a quantidade de QUILOWATTS (Use PONTO para a vírgula se for usar números decimais) do eletrodoméstico digitado: "));
    ...
    let valorPorKwh = parseFloat(prompt("Digite o custo do KWh (Use PONTO para a vírgula): R$ "));
